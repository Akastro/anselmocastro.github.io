        ...
        function c() {
            ...
            t.length > 0 && (z = {
                ...
                initWeekNames: function () {
                    "Segunda" == z.weekStart && (z.weekNames = ["Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado", "Domingo"]);
                ...
                createMonthHtml: function (e, t) {
                    var i = "",
                        ...
                        s = [];
                    "Segunda" == z.weekStart && (0 == o ? o = 6 : o -= 1), r.empty().html(this.monthNames[t]), l.empty().html(e);
